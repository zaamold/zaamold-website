        ...
        {events.map((event, i) => (
          ...
          >
            ...
            >
              ...
              {event.subtitle && <h4 className="text-sm">{event.subtitle}</h4>}
              {event.date && <p className="text-xs mt-1">{event.date}</p>}
              {event.description && (
                ...
                <div>
                  ...
                  <ul>
                    {event.links.map((link) => (
                      <li
                        key={link.name}
                        className="text-sm underline hover:text-purple-700 transition-all"
                      >
