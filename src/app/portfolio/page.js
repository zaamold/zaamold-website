    ...
    <main className="min-h-screen">
      ...
      <section className="px-6 pt-20 pb-10 bg-purple-50">
        ...
        <div className="max-w-4xl flex flex-col mx-auto gap-y-4">
          <p className="text-xl">
            I built this website using many of the technologies and techniques
            I've picked up during my career as a software developer. Consider it
            a part of my portfolio.
          </p>
          <p className="text-xl">
            I aim to always make my UI scale well for both desktop and mobile
            screens. You can test each page at different resolutions to see what
            I mean.
          </p>
        </div>
        <TechGrid />
        <p className="text-center text-xl">
          ...
          <a
            ...
            target="_blank"
            className="underline hover:text-purple-700 transition-all"
          >
            GitHub
          </a>
          .
